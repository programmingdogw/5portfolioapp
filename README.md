...
チーム開発の成果物はダミー箇所が多く中途半端だったので気持ち悪かった。


そのため商品の出品や購入、利益の確認まで普通に動くアプリは作りたかった。また一人である程度の規模のアプリをrails newからデプロイまでやってみたかったが、適当な規模だと考えた。
...
今までの時点では主に理由１の観点から一通りの機能を実装することに力を割いてきた。


現時点で実用に耐えるほどの物にはなっていないが下記のような改修をしながらUI/UXも整え、実際に使えるレベルまでコツコツ弄っていきたい。
...
## 良かった点
開発からデプロイ、売り上げのたて方まで実装するということを一通り経験出来た。（一応payjpでの購入で売り上げがたつようになっているので、いったんこちらのアプリに振り込んでもらい、利益分を振り込むような想定）。
...
railsで得た知見を元に、他の言語やフレームワークにも挑戦してみる。(現在phpとlaravelで開発中)スムーズに本番にデプロイできるようにDockerも勉強して使いたい。
